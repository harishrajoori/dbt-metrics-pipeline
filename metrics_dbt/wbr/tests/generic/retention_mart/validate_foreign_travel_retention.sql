{% test validate_foreign_travel_retention(model) %}
/* -- 
...
WITH 
	...
	(
		...
		AND 
			metric_name NOT IN ('EL moved to Retained over Previous New', 'Retained moved to Retained over Previous Retained', 'Resurrected moved to Retained over Previous Resurrected', 
			'EL moved to Churn over Previous New', 'Retained moved to Churn over Previous Retained', 'Resurrected moved to Churn over Previous Resurrected',
			'Current EL over Current EL + Current Retained', 'Current Resurrected over current Retained + current Resurrected', '28d Active to Inactive over Previous active'
			)
		GROUP BY 
			1,2,3,4,5
	),
