{%- macro gamperformancereport_extract() -%}
/* -- Script Name = 003_gamperformancereport_extract.sql :: BEGIN -- */
SELECT
    year_month_day
    , product_pl
    , region
    , line_item_level_cpm_and_cpc_revenue
    , line_item_level_impressions
    , line_item_level_clicks
    , line_item_name
FROM
    (
        SELECT
            ...
            , event_total_line_item_level_cpm_and_cpc_revenue AS line_item_level_cpm_and_cpc_revenue
            , event_total_line_item_level_impressions AS line_item_level_impressions
            , event_total_line_item_level_clicks AS line_item_level_clicks
            , event_line_item_name AS line_item_name
...
WHERE rn = 1
/* -- Script Name = 003_gamperformancereport_extract.sql :: END -- */
{%- endmacro -%}